    ...
    return(
        <Content>
            <Switch 
                ...
                checked={name === 'dark'}
                onColor={shade(0.8, colors.primary)}
                checkedIcon={
                    <div
                        style={{
                        display: "flex",
                    ...
                    >
                        <svg width="20" height="20" viewBox="0 0 159 141" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M27.463 0C27.4214 1.11733 27.4004 2.24085 27.4004 3.37038C27.4004 52.047 66.7995 91.5145 115.392 91.5145C131.009 91.5145 145.661 87.4096 158.358 80.2575C149.558 115.116 117.992 140.915 80.4 140.915C35.9963 140.915 0 104.918 0 60.5146C0 36.3844 10.6302 14.737 27.463 0Z" fill="#F9ED32"/>
                        </svg>
                    </div>
                }
                uncheckedIcon={
